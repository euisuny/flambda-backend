...
\newcommand{\step}{\longrightarrow_e}
...
\begin{flalign*}
  \mathbf{Environments}\\
  r ::=~& () \sep (r_1, \, r_2, \,\cdots) \sep \pi_i \; r \sep \langle \rho ,\, \lambda \rho \, k_r \, k_e \, x.e\rangle \\
...
\begin{mathpar}\footnotesize
  ...
  \inferrule
      [\footnotesize LetCode-$\beta$]
      {}
      {\eval{\letcodeexp{\codeid}{\lambda \rho \; k_r \; k_e \; x. e_1}{e_2}}{\rho}
        \step \eval{e}{\rebind{\rho}{\codeid}{\langle \rho, \lambda \rho \; k_r \; k_e \; x.e_1 \rangle}}}
  ...
  \inferrule
      ...
      {\eval{\apply{\direct \; \codeid}{\rho'}{res_k}{exn_k}{\args{\expr}}}{\rho}
        \step
        \langle \subst{e}{P}{\rho'}\substchain{k_r}{res_k}\substchain{k_e}{exn_k}\substchain{x}{\args{\expr}},\,
        \rho''\rangle}
